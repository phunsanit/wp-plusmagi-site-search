...
PlusMagi Post Archives is a lightweight, high-performance search replacement built to improve internal search accuracy with Ajax live search, cleaner result presentation, and deeper indexing across posts, pages, categories, tags, and custom fields.
...
If you need a custom search plugin that goes beyond native WordPress search, PlusMagi Post Archives helps surface hidden content, supports WooCommerce SKU-style metadata search, and keeps the search experience fast and easy to scan.
...
*   **Developer Friendly**: Supports shortcode `[plusmagi-post-archives]` (legacy `[plusmagi_search]` also supported) and Block Editor.
*   **High Performance**: Optimized with lightweight Ajax calls.
*   **WordPress 7.1 Ready**: Fully tested and optimized for WordPress 7.1 and PHP 7.4+.

For more information, visit [https://plusmagi-post-archives.plusmagi.com](https://plusmagi-post-archives.plusmagi.com).

== Installation ==

1.  Go to `Plugins > Add New` in WordPress, or download the plugin from `https://wordpress.org/plugins/plusmagi-post-archives`.
2.  Search for `PlusMagi Post Archives`.
3.  Click `Install Now`, then `Activate`.
4.  Add the `PlusMagi Post Archives` block or `[plusmagi-post-archives]` shortcode to any page or post.

== Frequently Asked Questions ==

= Does it support Private Posts and Drafts? =

Yes. PlusMagi Post Archives includes role-based filtering. Logged-in users with the right capabilities, such as Editors or Admins, can search private posts or drafts. Public visitors will only see content they are allowed to access.
...
1. Gutenberg editor block inserter showing the PlusMagi Post Archives block.
2. Ajax live search dropdown showing grouped results for Posts, Category, and Tag.
3. Frontend layout with the PlusMagi Post Archives widget integrated in a sidebar.

== Changelog ==

= 1.0.2 =
*   Added WordPress 7.1 full compatibility and verified support.
